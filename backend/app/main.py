...
def ensure_tables():
    ...
    with sqlite3.connect(db_path) as conn:
        ...
        migrations = {
            ...
            'community_reaction_summary': "ALTER TABLE issues ADD COLUMN community_reaction_summary TEXT NOT NULL DEFAULT ''",
            'community_reaction_bullets_json': "ALTER TABLE issues ADD COLUMN community_reaction_bullets_json TEXT NOT NULL DEFAULT '[]'",
...
def seed_if_empty():
    ...
    with Session(engine) as session:
        ...
        issue = Issue(
            ...
            community_reaction_summary='댓글에서는 도입 난이도보다 실제 운영에서 체감되는 성능 차이가 있는지가 더 흥미로운 포인트로 언급됩니다.',
            community_reaction_bullets_json='["벤치마크보다 운영 환경 재현성이 중요하다는 의견이 보입니다."]',
            telegram_sent=False,
            telegram_message='',
            telegram_error='',
